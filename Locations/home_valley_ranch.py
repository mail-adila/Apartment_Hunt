...
class HomeValleyRanch(object):

    URL = "https://cortland.com/apartments/cortland-at-valley-ranch/"

    def __init__(self, driver):
        self.driver = driver
        self.label_bedrooms = driver.find_element(By.XPATH, Locator.vr_label_bedrooms)
        self.checkbox_beds = driver.find_element(By.XPATH, Locator.vr_checkbox_beds)
        self.button_search = driver.find_element(By.XPATH, Locator.vr_button_search)
        self.close_cookies = driver.find_element(By.XPATH, Locator.vr_button_cookie_close)
