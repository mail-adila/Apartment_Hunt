...
class HomeNorthPlano(object):

    URL = "https://cortland.com/apartments/cortland-north-plano/"

    def __init__(self, driver):
        self.driver = driver
        self.label_bedrooms = driver.find_element(By.XPATH, Locator.np_label_bedrooms)
        self.checkbox_beds = driver.find_element(By.XPATH, Locator.np_checkbox_beds)
        self.button_search = driver.find_element(By.XPATH, Locator.np_button_search)
        self.close_cookies = driver.find_element(By.XPATH, Locator.np_button_cookie_close)
